...
use Modules\Review\Http\Requests\ReviewOldRequest;
use Modules\Review\Http\Resources\ReviewOldResource;
use Modules\Review\Models\ReviewOld;

class ReviewOldController extends Controller
{
     ...
     */
    public function store(ReviewOldRequest $request, $modelType, $modelId)
    {
        ...
        return response()->json(['review' => new ReviewOldResource($review->load('user', 'attachments'))], Response::HTTP_CREATED);
    }

    /**
     * Show the specified resource.
     */
    public function show($modelType, $modelId, ReviewOld $review): JsonResponse
    {
     ...
     */
    public function update(ReviewOldRequest $request, $modelType, $modelId, ReviewOld $review): JsonResponse
    {
        // Authorize the action using policies
        ...
        return response()->json(['review' => new ReviewOldResource($review->load('user', 'comments.user', 'attachments'))], Response::HTTP_OK);
    }

    /**
     * Remove the specified resource from storage.
     */
    public function destroy($modelType, $modelId, ReviewOld $review): JsonResponse
    {
        // Authorize the action using policies
    ...
    public function incrementHelpful($modelType, $modelId, ReviewOld $review)
    {
    ...
    public function decrementHelpful($modelType, $modelId, ReviewOld $review)
    {
